...
import History from "../../../../Github_Project_7_5/src/components/User_History/History";
...
const ProfileUI = () => {
  ...
  for (var i = 0; i < token.meetings.length; i++) {
    ...
    meetings.push({
      id: i,
      dr_name: token.meetings[i].doctor.username,
      slot: token.meetings[i].slot,
      date: token.meetings[i].Date,
      state: state,
    });
  }
  meetings.sort((a, b) => {
                              ...
                              <td>
                                ...
                                <ButtonGroup>
                                  ...
                                  <Button
                                    variant="outline-danger"
                                    className="col-md-12 text-right"
                                    onClick={(e) => cancel_order(e, item._id)}
                                  >
                                    <MdCancel />
                                  </Button>
                                </ButtonGroup>
