  ...
  const Get_Pharmacies_Api = ()=>{      
    ...
    useEffect(()=>{
      ...
      if (entity === "hospitals"){Get_Hospitals_Api();}
       ...
       else if (entity === "pharmacies") {Get_Pharmacies_Api();}
    },[entity])
  return (
    <div>
      <section className="section-container">
        <div className="hosp-title-info">
          ...
          {(entity === "clinics") && <h1 className="hosp-title">CLINICS</h1>}
           {(entity === "pharmacies") && <h1 className="hosp-title">Pharmacies</h1>}
          <hr />
        </div>
            ...
            <div className="hosp-item" key={hospital.id}>
              ...
              <div className="hosp-image-container">
                ...
                <p className="hosp-name">{hospital.name}</p>
                  ...
                  <Button className="OrderButton" onClick={() => handle_order(hospital)}>Make order</Button>
                  <PharmacyOrder 
